...
ActiveRecord::Schema[7.0].define(version: 2026_08_15_000001) do
  ...
  create_enum "fit_gap_narrative_status", ["complete", "failed", "skipped"]
  ...
  create_table "fit_gap_reports", force: :cascade do |t|
    ...
    t.enum "narrative_status", default: "complete", null: false, enum_type: "fit_gap_narrative_status"
